  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-3">
          {service.features.map((feature, featureIndex) => (
            <motion.div
              ...
              transition={{ delay: service.delay + 0.4 + featureIndex * 0.1 }}
        ...
        <div className="flex flex-col sm:flex-row gap-4 pt-4">
          <motion.button
            ...
            className={`px-6 py-3 bg-gradient-to-r ${service.color} rounded-xl font-medium text-white relative overflow-hidden group`}
          >
          ...
          <motion.button
            ...
            onMouseEnter={() => setCursorVariant('button')}
            onMouseLeave={() => setCursorVariant('default')}
            className="px-6 py-3 border-2 border-neonTeal text-neonTeal rounded-xl font-medium hover:bg-neonTeal hover:text-background transition-colors"
          >
      ...
      >
        ...
        <div className="relative aspect-square glassmorphism rounded-3xl p-8 overflow-hidden">
          {/* Background Pattern */}
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <motion.div
              ...
              className={`w-32 h-32 rounded-full bg-gradient-to-r ${service.color} opacity-20`}
            />
          </div>
          ...
          <div className="relative z-10 flex items-center justify-center h-full">
            <motion.div
              ...
              className={`w-24 h-24 rounded-2xl bg-gradient-to-r ${service.color} flex items-center justify-center shadow-2xl`}
            >
          ...
          {/* Hover Overlay */}
          <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-8">
            <div className="text-center">
              <Play size={24} className="text-white mx-auto mb-2" />
              <span className="text-white text-sm">Preview Work</span>
            </div>
          </div>

          {/* Glow Effect */}
          <div className={`absolute -inset-1 bg-gradient-to-r ${service.color} rounded-3xl opacity-0 group-hover:opacity-30 transition-opacity duration-500 blur-xl -z-10`} />
        </div>
        ...
        <motion.div
          ...
          className="absolute -bottom-4 -right-4 glassmorphism rounded-2xl p-4"
        >
          <div className="text-center">
